...
Build or update Arid's validation corpora beneath:
  <global-root>/$CORPUS_RELATIVE_PATH

Options:
  --black <revision>   Black Git revision. Default: upstream HEAD
  --django <revision>  Django Git revision. Default: upstream HEAD
  --mypy <revision>    mypy Git revision. Default: upstream HEAD
  --rich <revision>    Rich Git revision. Default: upstream HEAD
  --help               Show this help
...
echo "Validation corpora ready at:"
echo "  $CORPUS_ROOT"